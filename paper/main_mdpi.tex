...
\rev{Table~\ref{tab:workflow_summary} and Figure~\ref{fig:workflow_diagram} give a compact summary of the end-to-end benchmark workflow, from raw SpeakLeash data to final evaluation.}
